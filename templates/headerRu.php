    ...
    <div class="text-justify">
        <p>
            <em>Оценка существенности проводится в соответствии с рекомендациями международных Стандартов отчетности
                в области устойчивого развития Глобальной инициативы по отчетности GRI.</em>
            Ниже представлен перечень тем по результатам оценки существенности, а также примеры показателей.  <br><br>
